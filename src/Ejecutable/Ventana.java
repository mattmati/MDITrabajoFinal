...
public class Ventana extends JFrame implements Runnable {                       // Se implementa la interfaz "Runnable" para que se defina el cuerpo del método abstracto "run"          
    ...
    public static final int WIDTH = 1000, HEIGHT = 600;                          // static → porque se podrá acceder luego para las dimensiones de la ventana
...
//------------------------------    
    ...
    public Ventana(){
        ...
        setSize(Constantes.WIDTH, Constantes.HEIGHT);                                                 // Acá se pasan los valores del ancho y la altura
        ...
        canvas.setPreferredSize(new Dimension(Constantes.WIDTH, Constantes.HEIGHT));                  // Tamaño preferido
        canvas.setMaximumSize(new Dimension(Constantes.WIDTH, Constantes.HEIGHT));                    // Tamaño máximo
        canvas.setMinimumSize(new Dimension(Constantes.WIDTH, Constantes.HEIGHT));                    // Tamaño mínimo
